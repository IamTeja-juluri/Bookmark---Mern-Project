...
router.get("/logout",AuthMiddlewares.protect,UserController.logout)
...
router.patch("/updateprofilepicture",AuthMiddlewares.protect,upload.single("image"),UserController.updateUserProfilePicture)
